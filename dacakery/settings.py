"""
Django settings for dacakery project.
...
SECRET_KEY = 'django-insecure-l#hp8xcv*_8sp6hi6+d)zjujcg0!z+$^z%q%@i7%002x%7ts+w'
...
WSGI_APPLICATION = 'dacakery.wsgi.application'
